...
<!-- page content  Start Here -->
        ...
        <h2 style="color:red;margin:0 auto;margin-top:20%;">Your Are Not Permitted To Access This! Please Contract With Admin</h2>
        <h3 style="margin:0 auto;"> <a style="color:green;"  href="{{ route('home') }}">Back to home</a></h3>
