...
<!-- page content  Start Here -->
    ...
    <div class="card height-auto">
        ...
        <form action="{{ route('admin.account.store') }}" method="POST" class="new-added-form form-inline">
            @csrf
                <div class="row">
                    {{-- -
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group mobile_banking_type">
                        ...
                        <select name="mobile_banking_type_id" id="mobile_banking_type"  class="col-xl-8 col-lg-8 col-12 form-control">
                            <option value="">Please Select One</option>
                                ...
                                <option {{ old('mobile_banking_type_id') == $item->id ?'selected':''}} value="{{ $item->id}}">{{ $item->name}}</option> 
                                @endforeach
                        </select>
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group not_cash">
                        ...
                        <input type="text" value="{{old('account_name')}}" id="account_name" placeholder="Account Name" name="account_name" class="col-xl-8 col-lg-8 col-12 form-control">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group not_cash">
                        ...
                        <input name="account_no" id="account_no" value="{{old('account_no')}}" type="text" placeholder="Account No" class="col-xl-8 col-lg-8 col-12 form-control">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group not_cash">
                        ...
                        <input name="bank_name" id="bank_name" value="{{old('bank_name')}}" type="text" placeholder="Bank Name" class="col-xl-8 col-lg-8 col-12 form-control">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group not_cash">
                        ...
                        <input name="bank_address" id="bank_address" value="{{old('bank_address')}}" type="text" placeholder="Bank Address" class="col-xl-8 col-lg-8 col-12 form-control">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                        ...
                        <input name="amount" id="amount" value="{{old('amount')}}" type="text" placeholder="Opening Amount" class="col-xl-8 col-lg-8 col-12 form-control">
