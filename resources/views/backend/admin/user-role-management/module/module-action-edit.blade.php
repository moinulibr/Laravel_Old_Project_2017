...
<!-- page content  Start Here -->
    ...
    <div class="card height-auto">
        ...
        <form action="{{ route('admin.user-role-module-action.update',$module_action->id) }}" method="POST" class="new-added-form form-inline">
            @csrf
            @method("PUT")
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                        ...
                        <select name="user_role_module_id" id="user_role_module_id" class="col-xl-8 col-lg-8 col-12 form-control">
                            ...
                            @foreach ($modules as $item)
                                <option {{ $module_action->user_role_module_id == $item->id ?'selected':''}} value="{{$item->id}}">{{$item->module_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group not_cash">
                        ...
                        <input type="text" value="{{ $module_action->action_name ?? old('action_name') }}" id="action_name" name="action_name" class="col-xl-8 col-lg-8 col-12 form-control">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 form-group not_cash">
                        ...
                        <input name="action_checker_route_or_url" id="action_checker_route_or_url" value="{{ $module_action->action_checker_route_or_url ??  old('action_checker_route_or_url')}}" type="text" class="col-xl-8 col-lg-8 col-12 form-control">
