        ...
        <div class="col-sm-12 col-md-8">
            <div style="float:right">
                <ul>
                    <li>Admin</li>
                    <li>
                        <a href="{{ route('admin.role-module-action-permition.create') }}">Permission Create</a>
                    </li>
                    <li>
                       ...
                       <div class="row">
                        @foreach ($roles as $item)
                           ...
                           <div class="col-2"> 
                            ...
                            <a class="btn btn-primary" href="{{ route('admin.role-module-action-permition.edit',$item->id) }}"><i class="fas fa-edit text-orange-peel"></i>Edit</a>
                                               
                            <a class="btn btn-danger delete" href="#" data-url="{{route('admin.role-module-action-permition.delete',$item->id)}}"   data-toggle="modal" data-target="#myModal"><i class="fas fa-times" style="color:yellow"></i>Delete</a>
                           </div>
                           @endforeach
                       </div>
                    </div>
