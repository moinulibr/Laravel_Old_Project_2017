...
<!-- Breadcubs Area Start Here -->
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <h3>Module  Permission Update</h3>
        </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                @foreach($all_modules as $allTitle)
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        ...
                                        <input name="user_role_module_action_id[]" value="{{ $item->id }}"  @foreach($user_role->moduleActionPermission as $userChecked) {{ $userChecked->user_role_module_action_id == $item->id?'checked':'' }} @endforeach type="checkbox" class="col-xl-2 col-lg-2 col-12 form-control clickable">
