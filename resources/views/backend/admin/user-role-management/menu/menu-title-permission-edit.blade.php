...
<!-- Breadcubs Area Start Here -->
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <h3>Menu Title Permission Update</h3>
        </div>
                ...
                <div class="card height-auto mg-t-30">
                    <div class="heading-layout1">
                        <div class="item-title">
                            <h5>Update Menu Title Permission</h5>
                        </div>
                    </div>
                    <form method="POST" action="{{route('admin.role-menu-title-permition.update',$user_role->id)}}" class="new-added-form form-inline">
                        @csrf
                        @method("PUT")
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-12 form-group" style="margin-bottom:5%;">
                                ...
                                <input type="text" readonly value="{{ $user_role->name }}" class="col-xl-8 col-lg-8 col-12 form-control">
                                <input type="hidden" name="role_id" id="role_id"  value="{{ $user_role->id }}" class="col-xl-8 col-lg-8 col-12 form-control">
                            ...
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                ...
                                <div class="col-xl-12 col-lg-12 col-12 form-group">
                                    ...
                                    <input name="user_role_menu_title_id[]" value="{{ $item->id }}"   @foreach( $user_role->menuTitlePermission as $k) {{ $k->user_role_menu_title_id == $item->id ?'checked':'' }}  @endforeach type="checkbox" class="col-xl-2 col-lg-2 col-12 form-control clickable">
