        ...
        <div class="col-sm-12 col-md-8">
            <div style="float:right">
                <ul>
                    <li>User Menu </li>
                    <li>
                        <a href="{{ route('admin.role-menu-title.index') }}">Create Menu Action</a>
                    </li>
                    <li>
                        <a href="#">Home</a>
                    </li>
                            ...
                            <form method="POST" action="{{route('admin.role-menu-title.store')}}" class="new-added-form form-inline">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        <label class="col-xl-4 col-lg-4 col-12">Menu Nmae:</label>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        <label class="col-xl-4 col-lg-4 col-12">Menu Title Checker:</label>
                                    ...
                                    <div class="form-group col-12 mg-t-8">
                                        <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add Menu Title</button>
                                    </div>
                                </div>
                            </form>
                    </div>
                            ...
                            <table class="table display  text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Role Menue Title</th>
                                        <th>Role Menue Checker</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->menu_title_checker_route_or_url}}</td>
                                        <td>
                                           <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item edit" href="#"  data-checker="{{ $item->menu_title_checker_route_or_url }}"  data-name="{{ $item->menu_title }}" data-url="{{route('admin.role-menu-title.update',$item->id)}}"    data-toggle="modal" data-target="#myEditModal"><i class="fas fa-edit text-orange-peel"></i>Edit</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content modal-sm">
        ...
        <div class="modal-header">
          <h4 class="modal-title" style="text-align:center">Delete This Role Menu Title</h4>
    ...
    <div class="modal-dialog">
      <div class="modal-content modal-lg">
        <form action="" method="POST" id="editFormAction">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
            <h4 class="modal-title" style="text-align:center">Edit This Role Menu Title</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
                ...
                <div class="col-xl-12 col-lg-12 col-12 form-group">
                    <label class="col-xl-12 col-lg-12 col-12"> Menu Title:</label>
                ...
                <div class="col-xl-12 col-lg-12 col-12 form-group">
                    <label class="col-xl-12 col-lg-12 col-12"> Menu Title Checker:</label>
