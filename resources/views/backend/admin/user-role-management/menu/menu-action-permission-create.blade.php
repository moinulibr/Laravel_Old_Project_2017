...
<!-- Breadcubs Area Start Here -->
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <h3>Menu Action Permission Create</h3>
        </div>
        <div class="col-sm-12 col-md-8">
            <div style="float:right">
                <ul>
                    <li>Admin</li>
                    <li>
                        <a href="{{ route('admin.role-menu-action-permition.index') }}">Permission Index</a>
                    </li>
                    <li>
                ...
                <div class="card height-auto mg-t-30">
                    <div class="heading-layout1">
                        <div class="item-title">
                            <h5>Add Menu Action Permission</h5>
                        </div>
                    </div>
                    <form method="POST" action="{{route('admin.role-menu-action-permition.store')}}" class="new-added-form form-inline">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                @foreach ($all_menu_titles as $allTitle)

                                    <label class="col-xl-12 col-lg-12 col-12" style="text-align: center;margin-bottom:2%;border-top:.05px solid #ddd"><strong style="margin-bottom:2%;border-bottom:1px solid gray;color:green;font-size:17px;">{{ $allTitle->menu_title }}</strong></label>

                                    @foreach ($allTitle->menuTitleUseMenePermission as $item)
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        <label for="" class="col-xl-3 col-lg-3 col-12"></label>
                                        <input name="user_role_menu_action_id[]" value="{{ $item->id }}" {{ old('user_role_menu_action_id') == $item->id?'checked':'' }} type="checkbox" class="col-xl-2 col-lg-2 col-12 form-control clickable">
