...
<!-- Breadcubs Area Start Here -->
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <h3>Menu Action Permission Update</h3>
        </div>
                ...
                <div class="card height-auto mg-t-30">
                    <div class="heading-layout1">
                        <div class="item-title">
                            <h5>Update Menu Action Permission</h5>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                @foreach ($all_menu_titles as $allTitle)
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        ...
                                        <input name="user_role_menu_action_id[]" value="{{ $item->id }}" @foreach($user_role->menuActionPermission as $userChecked) {{ $userChecked->user_role_menu_action_id == $item->id?'checked':'' }} @endforeach type="checkbox" class="col-xl-2 col-lg-2 col-12 form-control clickable">
