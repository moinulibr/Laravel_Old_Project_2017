...
<!-- page content  Start Here -->
     ...
     <div class="card height-auto">
        <div class="card-body">
            ...
            <form action="{{ route('admin.transaction-expense.update',$final_expense->id) }}" method="POST" class="new-added-form ">
                @csrf
                @method("PUT")
                <div class="row">
                     <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <select  name="category_type" id="category_type" class="form-control select2" >
                           ...
                           @foreach ($categories as $item)
                            <option {{ $final_expense->category_type == $item->category_type ?'selected' :""}} value="{{ $item->category_type }}">{{ ucfirst($item->category_type) }}</option>
                           @endforeach
                        </select>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="category_details_div_selected" style="display:none;">
                        ...
                        <select name="" id="clickForHide" class="form-control">
                            <option value="{{ $final_expense->expense_category_id }}">{{ $final_expense->categories->name }}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Date</label>
                        <input name="expense_date" required value="{{ date('d-m-Y',strtotime($final_expense->expense_date)) ?? old('expense_date') }}" type="text" placeholder="dd/mm/yy" class="form-control air-datepicker" data-position="bottom right"><i class="far fa-calendar-alt"></i>
                    ...
                    <div class="table-responsive">
                        <table class="table display  text-nowrap" id="item_table">
                            ...
                            <tbody>
                                @foreach ($details_expenses as $item)
                                <tr>
                                    <td><label class="form-check-label">#{{ $loop->index +1 }}</label></td>
                                    <td>
                                        <input value="{{ $item->expense_title }}" name="expense_title[]" autocomplete="off"  style="width:100%;" type="text" placeholder="" class="col-xl-8 col-lg-8 col-12 form-control" style="width:100%;">
                                    </td>
                                    <td>
                                        <input value="{{ $item->description }}" name="description[]" autocomplete="off"  style="width:100%;" type="text" placeholder="" class="col-xl-8 col-lg-8 col-12 form-control">
                                    </td>
                                    <td>
                                        <input value="{{ $item->final_total }}" name="final_total[]" autocomplete="off"  type="text" value="0" placeholder="" class="col-xl-8 col-lg-8 col-12 form-control finalTotal">
                                    </td>
                                    <td style="width:12%;">
                                        <input value="{{  date('d-m-Y',strtotime($item->expense_created_date)) }}" name="expense_created_date[]"  autocomplete="off" type="text" placeholder="dd/mm/yy" style="width:80%;" class=" air-datepicker" data-position="bottom right">
                                    </td>
                                    <td>
                    ...
                    @if(check_menu_button('expenses','update'))
