        ...
        <div class="col-sm-12 col-md-8">
            <div style="float:right">
                <ul>
                    ...
                    <li>
                        <a href="{{route('admin.transaction-sale.create')}}">Create</a>
                    </li>
                    @endif
                </ul>
            </div>
...
<!-- page content  Start Here -->
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.transaction.sale.payment-process')}}" method="POST" class="new-added-form ">
                            @csrf
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Order No</label>
                                    <input type="text" value="{{$sale->order_no}}" class="form-control" readonly>
                                    <input name="order_no" type="hidden" value="{{$sale->order_no}}" class="form-control">
                                    <input name="id" type="hidden" value="{{$sale->id}}" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Receive From</label>
                                    <input type="text" value="{{$sale->users->name}}" class="form-control" readonly>
                                    <input name="client_id" type="hidden" value="{{$sale->client_id}}" class="form-control">
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <span >
                                    <strong style="color:red;">{{ $errors->first('payment_type_id') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Payment Method</label>
                                    <select required name="payment_method_id" id="payment_method_id" class="form-control">
                                        <option value="">Select One</option>
                                            ...
                                            <tr class="discount-rate-row">
                                                ...
                                                <td colspan="2">
                                                    <strong style="color:green;">Paid Amount 
                                                        <span style="margin-left:3%;color:blue;"> : ৳ {{$sale->paid_total}} </span>
                                                    </strong>
                                                    <input name="before_paid_total" id="before_paid_total" type="hidden" value="{{$sale->paid_total}}">
                                                </td>  
                                            </tr>
                                            </tr>
                                            <tr class="discount-rate-row">
                                                ...
                                                <td>৳ 
                                                    <strong>{{$sale->final_total}}</strong>
                                                    <input id="final_amount" name="final_total"  type="hidden" value="{{$sale->final_total}}" >
                                                
                                                    <!----total due now for jquery-->
                                                    <input  id="due_amount_now"   type="hidden" value="{{$sale->final_total - $sale->paid_total}}" >
                                                    <input id="payment_status" type="hidden" value="{{$sale->payment_status}}">
                                                        <!---for jquery check-->
                                                </td>
                                ...
                                <div class="form-group col-12 mg-t-8">
                                    @if(check_menu_button('sales','payment-receive-process'))
                                    <button type="submit" id="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add Payment</button>
                                    @endif
...
<!--===================================================================================================================================================-->
            ...
            <div id="payment_method_url" data-url="{{route('admin.transaction.sale.receive-payment-method')}}"></div>
...
<script>
    $(document).ready(function(){
        $('#paid_amount').on('keyup',function(){
            ...
            let dueAmount = (finalAmount - paidAmount).toFixed(2);
