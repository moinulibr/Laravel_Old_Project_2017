                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            @if(check_menu_button('purchases','create'))
                             <a href="{{ route('admin.transaction-purchase.create') }}" class="btn-fill-lg bg-blue-dark btn-hover-yellow"> Create Purchases</a>
                            @endif
                        </div>
                        {{-- 
                            <form class="mg-b-20">
                        ...
                        <div class="table-responsive">
                            <table class="table display text-nowrap">
                                ...
                                <tbody>
                                    @foreach($finalPurchases as $item)
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                         ...
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if(check_menu_button('purchases','create'))
                                                    <a class="dropdown-item" href="{{ route('admin.transaction.purchase.receive-payment',$item->id) }}"><i class="fas fa-check text-dark-pastel-green"></i>Pay Bill</a>
                                                    @endif
                                                    @if(check_menu_button('purchases','show'))
                                                    <a class="dropdown-item" href="{{ route('admin.transaction-purchase.show',$item->id) }}"><i class="fas fa-eye text-dark-pastel-green"></i>View</a>
                                                    @endif
                                                    {{-- -
                                                    @if(check_menu_button('purchases','edit'))
                                                    <a class="dropdown-item" href="{{ route('admin.transaction-purchase.edit',$item->id) }}"><i class="fas fa-edit text-dark-pastel-green"></i>Edit</a>
                                                    @endif
                                                    --}}
                                                    @if(check_menu_button('purchases','delete'))
                                                    <a class="dropdown-item delete" href="#" data-url="{{ route('admin.transaction.purchase.delete',$item->id) }}" data-toggle="modal" data-target="#myModal"><i class="fas fa-trash-alt text-orange-red"></i></i>Delete</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
    ...
    <div class="modal-dialog">
      <div class="modal-content modal-sm">
        ...
        <div class="modal-header">
          <h4 class="modal-title" style="text-align:center">Delete This Purchase Details</h4>
