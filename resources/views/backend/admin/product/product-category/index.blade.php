                ...
                <div class="col-6">
                    <div class="card height-auto mg-t-30">
                        <div class="heading-layout1">
                            ...
                            <form method="POST" action="{{route('admin.product-category.store')}}" class="new-added-form form-inline">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        <label class="col-xl-4 col-lg-4 col-12">Category Name:</label>
                                        <input name="name" type="text" value="{{old('name')}}" placeholder="Category Name" class="col-xl-8 col-lg-8 col-12 form-control">
                                        @if($errors->has('name'))
                                    ...
                                    --}}
                                    @if(check_menu_button('product_categories','create'))
                                        ...
                                        <td>
                                           <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if(check_menu_button('product_categories','edit'))
                                                    <a class="dropdown-item edit" href="#"  data-name="{{ $item->name }}" data-url="{{route('admin.product-category.update',$item->id)}}"    data-toggle="modal" data-target="#myEditModal"><i class="fas fa-edit text-orange-peel"></i>Edit</a>
                                                    @endif
                                                    @if(check_menu_button('product_categories','delete'))
                                                    <a class="dropdown-item delete" href="#" data-url="{{route('admin.product-category.delete',$item->id)}}"   data-toggle="modal" data-target="#myModal"><i class="fas fa-times text-orange-red"></i>Delete</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
    ...
    <div class="modal-dialog">
      <div class="modal-content modal-sm">
        <form action="" method="POST" id="editFormAction">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
            <h4 class="modal-title" style="text-align:center">Edit This Category</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
           @if(check_menu_button('product_categories','update'))
