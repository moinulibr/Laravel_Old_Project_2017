                    ...
                    <div class="card height-auto">
                        <div class="card-body">
                            <div class="heading-layout1">
                                ...
                                <a href="{{route('admin.product.create')}}" class="btn-fill-lg bg-blue-dark btn-hover-yellow"><i class="fas fa-plus"></i> Add Products</a>
                                @endif
                            </div>
                            {{-- -
                            <form class="mg-b-20">
                                ...
                                <table class="table display text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            @if ($item->image)
                                                @if(Storage::disk('public')->exists('product-image/',"{$item->id}".$item->image))
                                                <img src="{{ asset('storage/product-image/'.$item->id) }}" width="40" height="30" alt="product image" style="border-radius: 50%;">
                                                @endif
                                            @endif
                                            </td>
                                            <td>{{$item->name}}</td>
                                             ...
                                             <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if(check_menu_button('products','edit'))
                                                        <a class="dropdown-item" href="{{route('admin.product.edit',$item->id)}}"><i class="fas fa-edit text-orange-peel"></i>Edit</a>
                                                        @endif
                                                        @if(check_menu_button('products','delete'))
                                                        <a class="dropdown-item delete" href="#" data-url="{{route('admin.product.delete',$item->id)}}"  data-toggle="modal" data-target="#myModal"><i class="fas fa-times text-orange-red"></i>Delete</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
