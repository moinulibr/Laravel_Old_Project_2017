...
<!-- page content  Start Here -->
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.product.update',$product->id) }}" method="POST" class="new-added-form form-inline" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-12 form-group">
                                    ...
                                    <label for="exinc-type-2" class="radio-inline">
									    <input type="radio" {{ $product->product_type =="Goods"?'checked':'' }} class="exinc-type" id="exinc-type-1" name="product_type" value="Goods" required="">Goods
									    <input type="radio" {{ $product->product_type =="Service"?'checked':'' }} class="exinc-type" id="exinc-type-2" name="product_type" value="Service" required="">Service
                                    </label>
                                ...
                                <div class="col-xl-12 col-lg-12 col-12 form-group">
                                    ...
                                    <input name="name" value="{{$product->name}}" id="name" type="text" placeholder="Product Name" class="col-xl-8 col-lg-8 col-12 form-control">
                                    @if($errors->has('name'))
                                    <span class="margin-left-33">
                                ...
                                @if(check_menu_button('products','update'))
                                <div class="form-group col-12 mg-t-8">
                                    <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Update Product</button>
                                </div>
                                @endif
                            </div>
                        </form>
