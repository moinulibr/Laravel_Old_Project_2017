            ...
            <div class="card-body">
                <div class="heading-layout1">
                    ...
                    @if(check_menu_button('users','user-create'))
                        <a href="{{route('admin.userCreateFrom',"client")}}" class="btn-fill-lg bg-blue-dark btn-hover-yellow"><i class="fas fa-plus"></i> Add Clients</a>
                    @endif
                </div>
                {{-- 
                <form class="mg-b-20">
                            ...
                            <tr>
                                ...
                                <td class="text-left"> 
                                    @if ($item->image)
                                        ...
                                        <img src="{{ asset('storage/user-image/'.$item->id.'.'.$item->image) }}" alt="" width="40" height="40" style="border-radius: 50%;">
                                        @endif
                                        @else
                                 ...
                                 <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if(check_menu_button('clients','show'))
                                            <a class="dropdown-item" href="{{ route('admin.client.show',$item->id) }}"><i class="fas fa-eye text-dark-pastel-green"></i>View</a>
                                            @endif
                                            @if(check_menu_button('users','user-edit'))
                                            <a class="dropdown-item" href="{{ route('admin.userEditFrom',["client",$item->id])}}"><i class="fas fa-edit text-orange-peel"></i>Edit</a>
                                            @endif
                                            @if(check_menu_button('users','user-delete'))
                                            <a class="dropdown-item delete" data-url="{{ route('admin.userDeleteFrom',["client",$item->id]) }}" data-toggle="modal" data-target="#myModal"  href="#"><i class="fas fa-times text-orange-red"></i>Delete</a>
                                            @endif
                                        </div>
                                    </div>
                                </td>
    ...
    <div class="modal-dialog">
      <div class="modal-content modal-sm">
        ...
        <div class="modal-header">
          <h4 class="modal-title" style="text-align:center">Delete This Client Details</h4>
