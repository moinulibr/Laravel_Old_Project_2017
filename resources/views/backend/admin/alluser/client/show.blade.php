     ...
     <div class="card height-auto">
        <div class="card-body">
            ...
            <div class="single-info-details">
                <div class="item-img">
                    @if ($client->image)
                    @if(Storage::disk('public')->exists('user-image/',"{$client->id}".$client->image))
                    <img src="{{ asset('storage/user-image/'.$client->id) }}" alt="" height="250" width="250">
                    @endif
                    @else
                    <img src="{{ asset('links') }}/img/figure/user.jpg" alt="client"height="250" width="250">
                @endif
                </div>
                    ...
                    <div class="header-inline item-header">
                        ...
                        <div class="header-elements">
                            <ul>
                                ...
                                <li><a href="{{ route('admin.userEditFrom',['client',$client->id]) }}"><i class="far fa-edit"></i></a></li>
                                @endif
                                @if(check_menu_button('clients','print-all'))
                                <li><a href="{{ route('admin.client.print',$client->id) }}" class="btnPrint"><i class="fas fa-print"></i></a></li>
                                @endif
                    ...
                    <div class="info-table table-responsive" >
                        <table class="table text-nowrap">
                            <tbody>
                                <tr>
                                    <td>Client Name:</td>
                                    <td class="font-medium text-dark-medium">{{ucfirst($client->name)}}</td>
                                </tr>
                                <tr>
                                    <td>Phone Number:</td>
                                    <td class="font-medium text-dark-medium">{{$client->phone}} </td>
                                </tr>
                                <tr>
                                    <td>Email:</td>
                                    <td class="font-medium text-dark-medium">{{$client->email}} </td>
                                </tr>
                                <tr>
                                    <td>Clients Address:</td>
                                    <td class="font-medium text-dark-medium">{{$client->address}}</td>
                                </tr>
                                <tr>
                                    <td>Company Name:</td>
                                    <td class="font-medium text-dark-medium">{{$client->company_name}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                ...
                                <td>
                                  @if($item->account_id)
                                    ...
                                    <span style="color:green">Cash</span>
                                      @else
                                        @if($item->accounts->bank_name != NULL)
