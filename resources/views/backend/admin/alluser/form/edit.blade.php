...
<!-- page content  Start Here -->
     ...
     <div class="card height-auto">
        <div class="card-body">
            ...
            <form action="{{ route('admin.user.update',$user->id) }}" method="POST" class="new-added-form" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label> Name *</label>
                        <input name="name" value="{{ $user->name ?? old('name') }}"  type="text" placeholder="" class="form-control">
                        @if ($errors->has('name'))
                        <span  role="alert" >
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>E-Mail</label>
                        <input name="email" value="{{ $user->email ?? old('email') }}" type="email" placeholder="" class="form-control">
                        @if ($errors->has('email'))
                        <span  role="alert" >
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Phone</label>
                        <input name="phone" value="{{ $user->phone ??  old('phone') }}" type="text" placeholder="" class="form-control">
                        @if ($errors->has('phone'))
                        <span  role="alert" >
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Phone (2)</label>
                        <input name="phone_2" value="{{ $user->phone_2 ??  old('phone_2') }}" type="text" placeholder="" class="form-control">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Address</label>
                        <input name="address" value="{{ $user->address ?? old('address') }}" type="text" placeholder="" class="form-control">
                ...
                @if ($user_type == 'employee')
                    <div class="col-xl-3 col-lg-6 col-12 form-group ">
                        <label>ID No</label>
                        <input name="id_no" value="{{ $user->id_no ?? old('id_no') }}" type="text" placeholder="" class="form-control">
                        @if ($errors->has('id_no'))
                        <span  role="alert" >
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <select name="religion" class="select2">
                            ...
                            <option {{  $user->religion == 'Buddish' ?'selected':'' }} value="Buddish">Buddish</option>
                            <option {{  $user->religion == 'Others' ?'selected':'' }} value="Others">Others</option>
                        </select>
                    ...
                    <div class="col-lg-6 col-12 form-group ">
                        ...
                        <textarea class="textarea form-control" name="bio" id="form-message" cols="10" rows="9">{{ $user->bio }}</textarea>
                    </div>
                    @endif
                    <!--Only Employee end--->
                    ...
                    @if ($user_type == 'supplier' || $user_type == 'client')
                        <div class="col-xl-3 col-lg-6 col-12 form-group ">
                            ...
                            <input name="company_name" value="{{ $user->company_name ?? old('company_name') }}" type="text" placeholder="Company Name" class="form-control">
                    ...
                    @if(check_menu_button('users','update'))
                        <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Update {{ ucfirst($user_type) }}</button>
                    @endif
                    </div>
                </div>
            </form>
