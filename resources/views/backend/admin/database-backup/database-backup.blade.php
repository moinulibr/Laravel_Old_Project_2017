          ...
          <div class="card height-auto">
            <div class="card-body">
                <div class="heading-layout1">
                    ...
                    <a href="{{route('databaseBackRun')}}" class="btn-fill-lg bg-blue-dark btn-hover-yellow"><i class="fas fa-plus"></i> Database Backup</a>
                    @endif
                </div>
                {{-- -
                <form class="mg-b-20">
                    ...
                    <table class="table display text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  class="dropdown-item" href="{{ route('dbBackupDownload',$item->getFileName()) }}"><i class="fas fa-download text-orange-red"></i>Download</a>
                                </td>
                                <td>
                                    <a  class="dropdown-item" href="{{ route('dbBackupDelete',$item->getFileName()) }}"><i class="fas fa-times text-orange-red"></i>Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
