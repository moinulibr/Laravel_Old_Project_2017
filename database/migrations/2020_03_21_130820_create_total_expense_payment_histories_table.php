...
class CreateTotalExpensePaymentHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    { 
        Schema::create('total_expense_payment_histories', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('total_expense_payment_histories');
    }
}
